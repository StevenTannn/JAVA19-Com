public class TestComputer {
	public static void main(String[] args) {
		...
		for (int x = 1; x < 5; x++)
			myComputer.replaceMemory(x, null);
		...
		String expectedSpec = "CPU: Intel 3.4Ghz 8 core(s)\n" + "===\n" + "Memory: 8GB\n" + "Slot 1: 4GB\n"
				+ "Slot 3: 4GB\n" + "===\n" + "Storage: 640GB\n" + "SSD: 128GB\n" + "HDD: 512GB\n" + "===\n"
				+ "PSU: 600watt";

		System.out.println(expectedSpec.equals(myComputer.getSpec()));

		System.out.println(myComputer.getSpec());

		myComputer.addStorage(new SSD(1024));

		expectedSpec = "CPU: Intel 3.4Ghz 8 core(s)\n" + "===\n" + "Memory: 8GB\n" + "Slot 1: 4GB\n" + "Slot 3: 4GB\n"
				+ "===\n" + "Storage: 1664GB\n" + "SSD: 128GB\n" + "HDD: 512GB\n" + "SSD: 1024GB\n" + "===\n"
				+ "PSU: 600watt";
